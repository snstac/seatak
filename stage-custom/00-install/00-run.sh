...
# Node-RED:
install -v -m 644 files/seatak-flows.json	"${ROOTFS_DIR}/home/node-red/.node-red/"
cat "${ROOTFS_DIR}/home/node-red/.node-red/seatak-flows.json" > "${ROOTFS_DIR}/home/node-red/.node-red/flows.json"
...
# SeaTAK Env configuration
install -v -m 644 files/seatak-config.txt	"${ROOTFS_DIR}/boot/"
install -v -m 755 files/99-seatak-dispatcher "${ROOTFS_DIR}/etc/NetworkManager/dispatcher.d/"
install -v -m 644 files/README-SeaTAK.txt "${ROOTFS_DIR}/"
